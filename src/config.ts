...
export const siteConfig: SiteConfig = {
	...
	wallpaper: {
		...
		src: {
			// 桌面壁纸图片 (支持单张图片或图片数组，当数组长度 > 1 时自动启用轮播)目录在 /public/assets中
			desktop: ["/assets/desktop-banner/01.jpg"],
			// 移动壁纸图片 (支持单张图片或图片数组，当数组长度 > 1 时自动启用轮播)
			mobile: ["/assets/mobile-banner/02.jpg"],
		},
		...
		playlist: [
			{
				...
				// 封面
				cover:
					"https://p1.music.126.net/PhKOqFtljgHDDpKYM2ADUA==/109951169858309716.jpg",
				// 路径
